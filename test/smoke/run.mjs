...
//      wedge the instance).
//   2. A GIF transcode still runs on that same instance afterwards — a crash in
//      (1) used to wedge every later exec.
//
// Exit code 0 = both webm outputs were produced with the expected properties.
